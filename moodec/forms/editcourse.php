...
class moodec_edit_course_form extends moodleform {
	...
	public function definition() {
		...
		$mform->addElement('select', 'price_model', get_string('price_model', 'local_moodec'), array('simple'=>'Simple','variable'=>'Variable')); // Add elements to your form
		...
		$mform->disabledif('simple_price', 'price_model', 'neq', 'simple');
		...
		$mform->disabledif('simple_enrolment_duration', 'price_model', 'neq', 'simple');
		...
		$mform->disabledif('simple_group_1', 'price_model', 'neq', 'simple');
		...
		$mform->disabledif('variable_tiers', 'price_model', 'neq', 'variable');
			...
			$mform->disabledif('variable_name_1', 'price_model', 'neq', 'variable');
			...
			$mform->disabledif('variable_price_1', 'price_model', 'neq', 'variable');
			...
			$mform->disabledif('variable_enrolment_duration_1', 'price_model', 'neq', 'variable');
			...
			$mform->disabledif('variable_group_1', 'price_model', 'neq', 'variable');
			...
			$mform->disabledif('variable_name_2', 'price_model', 'neq', 'variable');
			...
			$mform->disabledif('variable_price_2', 'price_model', 'neq', 'variable');
			...
			$mform->disabledif('variable_enrolment_duration_2', 'price_model', 'neq', 'variable');
			...
			$mform->disabledif('variable_group_2', 'price_model', 'neq', 'variable');
			...
			$mform->disabledif('variable_name_3', 'price_model', 'neq', 'variable');
			...
			$mform->disabledif('variable_price_3', 'price_model', 'neq', 'variable');
			...
			$mform->disabledif('variable_enrolment_duration_3', 'price_model', 'neq', 'variable');	
			...
			$mform->disabledif('variable_name_4', 'price_model', 'neq', 'variable');
			...
			$mform->disabledif('variable_price_4', 'price_model', 'neq', 'variable');
			...
			$mform->disabledif('variable_enrolment_duration_4', 'price_model', 'neq', 'variable');	
			...
			$mform->disabledif('variable_group_4', 'price_model', 'neq', 'variable');
			...
			$mform->disabledif('variable_name_5', 'price_model', 'neq', 'variable');
			...
			$mform->disabledif('variable_price_5', 'price_model', 'neq', 'variable');
			...
			$mform->disabledif('variable_enrolment_duration_5', 'price_model', 'neq', 'variable');	
			...
			$mform->disabledif('variable_group_5', 'price_model', 'neq', 'variable');
